...
\fancyhead{}
\def\thetitle{Enhancing Digital Security: A Zero-Knowledge Proof-Based Authentication System for User Privacy Protection -- Project Proposal}
\title{\thetitle}
...
\input{abstract}
\maketitle
\keywords{Zero Knowledge Proof, Authentication, Privacy, Security, Cryptography}
